<footer class="bg-gray-800 text-white py-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-xl font-bold mb-4">Pawsome</h3>
                <p class="text-gray-300">Premium pet supplies for your furry friends.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-gray-300 mb-2">123 Pet Street, Furry City, PC 12345</p>
                <p class="text-gray-300 mb-2">Email: info@pawsome.com</p>
                <p class="text-gray-300 mb-4">Phone: (123) 456-7890</p>
        ...
        <div class="mt-8 pt-8 border-t border-gray-700 text-center">
            <p class="text-gray-300">&copy; {{ date('Y') }} Pawsome Pet Supplies. All rights reserved.</p>
        </div>
    </div>
</footer>
